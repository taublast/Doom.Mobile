        ...
        public void Update()
        {
            ...
            for (var i = 0; i < infos.Length; i++)
            {
                ...
                if (info.Playing != Sfx.NONE)
                {
                    ...
                    {
                        //Trace.WriteLine($"[SOUND] stop {info.Playing}");
                ...
                if (info.Reserved != Sfx.NONE)
                {
                    ...
                    //Trace.WriteLine($"[SOUND] play {info.Playing}");
                }
            }
            ...
            if (uiReserved != Sfx.NONE)
            {
                ...
                uiChannel.Play();
                //Trace.WriteLine($"[SOUND] play reserved {uiReserved}");
                uiReserved = Sfx.NONE;
            }
        ...
        public void StartSound(Mobj mobj, Sfx sfx, SfxType type, int volume)
        {
            ...
            for (var i = 0; i < infos.Length; i++)
            {
                ...
                if (info.Source == mobj && info.Type == type)
                {
                    ...
                    info.Volume = volume;
                    //Trace.WriteLine($"[SOUND] will play new {sfx}");
                    return;
                }
            }
            ...
            for (var i = 0; i < infos.Length; i++)
            {
                ...
                if (info.Reserved == Sfx.NONE && info.Playing == Sfx.NONE)
                {
                    ...
                    info.Type = type;
                    info.Volume = volume;
                    //Trace.WriteLine($"[SOUND] will play along {sfx}");
                    return;
                }
            }
